package ru.otus.hw12CacheEngine.sessionmanager;
...
import ru.otus.hw12CacheEngine.api.sessionmanager.SessionManagerException;
...
public class SessionManagerHibernate implements SessionManager {
  ...
  public Query createNativeQuery(String queryString) {
    return getCurrentSession().getHibernateSession().createNativeQuery(queryString);
  }
